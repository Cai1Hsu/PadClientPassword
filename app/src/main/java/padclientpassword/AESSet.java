...
import padclientpassword.AESUtils;
...
public class AESSet {
    ...
    /* renamed from: iv */
    private String f28iv = "fedcba9876543210";
    private IvParameterSpec ivspec = new IvParameterSpec(this.f28iv.getBytes());
    ...
    private static String padString(String source) {
        ...
        for (int i = 0; i < padLength; i++) {
            source = String.valueOf(source) + 0;
        }
        return source;
    }
}